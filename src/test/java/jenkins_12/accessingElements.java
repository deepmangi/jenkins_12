...
public class accessingElements {
  ...
  public void Tutorialslogin() {
    ...
    // value cannot be stored in page.type//can also add css selector as
    // "[type=password]"
    // page.locator("#uname"/*can also be given as
    // "id=uname"*/).type("divyarajbhanushali@gmail.com");//accessing email textbox
    // using css selector
    ...
    // page.click("#root > div > section > div > div > form >
    // div.footer.text-center.pt-lg-4.pt-3 > button")//clicking on button;
